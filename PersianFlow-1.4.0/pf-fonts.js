/* ============================================================
   Persian Flow v1.4.0 — رجیستری مشترک فونت‌ها (منبع واحد — ۱۵ فونت)
   ------------------------------------------------------------
...
(function (root) {
  ...
  var FONTS = [
    ...
    {
      id: "amiri",
      // «آمیری» — همان Amiri که فایلش (Amiri.woff2) و لایسنسش
      // (fonts/licenses/Amiri-OFL.txt، پروژه‌ی aliftype/amiri) در بسته است.
      // «آمیتا» (Amita) فونتِ دیگری است و عمداً بسته‌بندی نشده.
      faName: "آمیری",
      family: "Amiri",
      variable: false,
      designer: "خالد حسنی — پروژه‌ی آمیری (aliftype/amiri)",
