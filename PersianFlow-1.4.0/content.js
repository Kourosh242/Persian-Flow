...
(function () {
  ...
  function rulesCSS() {
    ...
    var s = "." + RTL_CLASS + Z + "{unicode-bidi:plaintext!important;text-align:right!important}"
      + "." + RTLDIR_CLASS + Z + "{direction:rtl!important;unicode-bidi:isolate!important}"
      + "." + RTL_CLASS + Z + " pre," + "." + RTL_CLASS + Z + " code{text-align:left!important}"
      ...
      + "." + RTLFLEX_CLASS + Z + "{direction:rtl!important;text-align:right!important}"
      + "." + RTLFLEXEND_CLASS + Z + "{direction:rtl!important;text-align:right!important;justify-content:flex-start!important}"
      + "." + FONT_CLASS + Z + "," + "." + FONT_CLASS + Z + " *{"
      + "font-family:'Vazirmatn',Tahoma,'Segoe UI',sans-serif,"
      + "'Apple Color Emoji','Segoe UI Emoji','Noto Color Emoji'!important;}";
    for (var i = 0; i < FONTS.length; i++) {
      s += "." + famClass(FONTS[i].id) + Z + "," + "." + famClass(FONTS[i].id) + Z + " *{"
